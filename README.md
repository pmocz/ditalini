...
The `pip` workflow runs automatically after each commit
...
produce binary wheels for a variety of platforms. A `pypi_password`
token is provided using GitHub Action's _secrets_ feature in order to upload the package to PyPI.
