...
# usage instructions.
#
# 2018-03-31, Bendik Samseth - Relax debug output. - Keep a copy of the coverage
# output for later use. - Updated coverage exclude patterns.
#
# 2018-01-03, HenryRLee - Allow for *Clang compiler names, not just Clang.
#
# 2018-01-03, Bendik Samseth - Only check compiler compatibility if in a
# coverage build.
...
function(setup_target_for_coverage _targetname _testrunner _outputname)
  ...
  add_custom_target(
    ...
    COMMAND ${LCOV_PATH} --directory . --capture --output-file
            ${_outputname}.info
    COMMAND
      ${LCOV_PATH} --remove ${_outputname}.info '*/tests/*' '/usr/*'
      '*/external/*' '*/3rd/*' '/Applications/*' --output-file
...
if(cmake_build_type_tolower STREQUAL "coverage")
  ...
  # If unwanted files are included in the coverage reports, you can adjust the
  # exclude patterns on line 83.
  setup_target_for_coverage(
    coverage # Name for custom target.
    ${TEST_MAIN} # Name of the test driver executable that runs the tests. NOTE!
                 # This should always have a ZERO as exit code otherwise the
